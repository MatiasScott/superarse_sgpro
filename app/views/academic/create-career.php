    ...
    <div class="main-content">
        <main class="max-w-3xl mx-auto">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-8 rounded-t-2xl shadow-xl">
                ...
                <h1 class="text-3xl font-bold text-center mb-2">Nueva Carrera</h1>
                <p class="text-center text-emerald-100 text-sm">
                    Complete la información para registrar una nueva carrera
                </p>
            </div>

            <form action="<?php echo BASE_PATH; ?>/academic/careers/store" method="POST" class="bg-white p-8 rounded-b-2xl shadow-xl space-y-6">
                ...
                <div style="background-color: rgba(220, 252, 231, 0.6); padding: 1.5rem; border-radius: 0.75rem; border: 2px solid rgb(167, 243, 208);">
                    ...
                    <input type="text" id="name" name="name" required style="width: 100%; padding: 0.75rem 1rem; border: 2px solid rgb(110, 231, 183); border-radius: 0.5rem; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);" placeholder="Ejemplo: Ingeniería en Sistemas">
                </div>
                ...
                <div style="background-color: rgba(224, 242, 254, 0.6); padding: 1.5rem; border-radius: 0.75rem; border: 2px solid rgb(186, 230, 253);">
                    <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                        ...
                        <h3 style="font-size: 1.125rem; font-weight: bold; color: rgb(31, 41, 55);">Código (opcional)</h3>
                    </div>
                    <input type="text" id="code" name="code" style="width: 100%; padding: 0.75rem 1rem; border: 2px solid rgb(125, 211, 252); border-radius: 0.5rem; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);" placeholder="Ejemplo: ISW-01">
                </div>
                ...
                <div style="background-color: rgba(243, 244, 246, 0.8); padding: 1.5rem; border-radius: 0.75rem; border: 2px solid rgb(229, 231, 235);">
                    <div style="display: flex; align-items: center; margin-bottom: 1rem;">
                        ...
                        <h3 style="font-size: 1.125rem; font-weight: bold; color: rgb(31, 41, 55);">Descripción (opcional)</h3>
                    </div>
                    <textarea id="description" name="description" rows="4" style="width: 100%; padding: 0.75rem 1rem; border: 2px solid rgb(209, 213, 219); border-radius: 0.5rem; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);" placeholder="Descripción opcional de la carrera"></textarea>
                </div>
