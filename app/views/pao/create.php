...
<body class="bg-gray-100 font-sans">
    ...
    <div class="main-content">
        <main class="max-w-3xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-8 rounded-t-2xl shadow-xl">
                <div class="flex items-center justify-center mb-4">
                    <div class="bg-white bg-opacity-20 p-4 rounded-xl backdrop-blur-sm">
                        <i class="fas fa-folder-plus text-5xl"></i>
                    </div>
                </div>
                <h1 class="text-3xl font-bold text-center mb-2">Nuevo PAO</h1>
                <p class="text-center text-purple-100 text-sm">
                    Complete la información necesaria para crear el Programa Académico Operativo
                </p>
            </div>

            <form action="<?php echo BASE_PATH; ?>/pao/store" method="POST" class="bg-white p-8 rounded-b-2xl shadow-xl space-y-6"> 
                ...
                <div style="background-color: rgba(243, 232, 255, 0.5); padding: 1.5rem; border-radius: 0.75rem; border: 2px solid rgb(233, 213, 255);">
                    ...
                    <input type="text" id="name" name="name" required style="width: 100%; padding: 0.75rem 1rem; border: 2px solid rgb(216, 180, 254); border-radius: 0.5rem; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);" placeholder="Ejemplo: PAO 2024-2025">
                ...
                <div style="background-color: rgba(219, 234, 254, 0.5); padding: 1.5rem; border-radius: 0.75rem; border: 2px solid rgb(191, 219, 254);">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <div>
                            ...
                            <input type="date" id="start_date" name="start_date" required style="width: 100%; padding: 0.75rem 1rem; border: 2px solid rgb(147, 197, 253); border-radius: 0.5rem; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
                        </div>
                        <div>
                            <label style="display: block; font-size: 0.875rem; font-weight: 600; color: rgb(55, 65, 81); margin-bottom: 0.5rem;">Fecha de Fin</label>
                            <input type="date" id="end_date" name="end_date" required style="width: 100%; padding: 0.75rem 1rem; border: 2px solid rgb(147, 197, 253); border-radius: 0.5rem; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
                        </div>
                    </div>
                ...
                <div style="display: flex; gap: 1rem; padding-top: 1.5rem;">
                    ...
                    <button type="submit" style="flex: 1; padding: 0.75rem 1.5rem; background: linear-gradient(to right, rgb(168, 85, 247), rgb(236, 72, 153)); color: white; border-radius: 0.75rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); font-weight: 600; border: none; cursor: pointer;">
